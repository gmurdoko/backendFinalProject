...
func UserController(r *mux.Router, service userUsecase.UserUsecase) {
	...
	user.HandleFunc("/saldo", userHandler.GetSaldo).Methods(http.MethodGet)
	user.HandleFunc("/saldo", userHandler.UpdateUserSaldoTopUp).Methods(http.MethodPut)
	user.HandleFunc("/photo", userHandler.DeleteUserPhoto).Methods(http.MethodDelete)
	user.HandleFunc("/photo", userHandler.GetUserPhoto).Methods(http.MethodGet)
	user.HandleFunc("/photo", userHandler.DeleteUserPhoto).Methods(http.MethodPut)
